...
test('Should not signup user with invalid name/email/password', async () => {
    const response = await request(app)
        ...
        .expect(400) // error generated by /users post route
})
...
test('Should not update user if unauthenticated', async () => {
    const respose = await request(app)
        ...
        .set('Authorization', `Bearer ${userOne.tokens[0].token}` + 123) // + 123 to fail the auth token
        .expect(401) // error generated by auth.js
})
...
test('Should not update user with invalid name/email/password', async () => {
    const response = await request(app)
        ...
        .set('Authorization', `Bearer ${userOne.tokens[0].token}`)
        .expect(400) // error generated by /users/me patch route
